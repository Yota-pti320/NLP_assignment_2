...
def extract_features_and_labels(sentence):
    ...
    for token in sentence:
        ...
        if label not in ['V', '_']:
            ...
            new_sentence = [lemma, arg_POS, predicate_lemma, predicate_POS, voice, label]
    return new_sentence
